...
def createpublist(year):
    ...
    categs = mysession.query(distinct(publication.category)).\
        ...
        filter(publication.pub_date<dt(year,12,31,0,0,0)).all() #distinct categories
    #print categs
    ...
    for x in categs:
        ...
        categories.append(x[0])   #this line breaks it
    ...
    print len(solaratlasgr)
    print len(conferencegr)
    print len(pubsgr)
